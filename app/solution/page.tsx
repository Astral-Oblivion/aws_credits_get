...
export const metadata: Metadata = {
  title: "Solution - Alpine Energy Systems",
  description:
    "Discover how Alpine's IoT-powered energy management platform reduces building energy consumption by 20-40% through real-time monitoring and AI optimization.",
};
