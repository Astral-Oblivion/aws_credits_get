...
export const metadata: Metadata = {
  title: "Terms of Service - Alpine Energy Systems",
  description: "Alpine Energy Systems terms of service and usage agreement.",
};
        ...
        <div className="prose prose-slate max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing and using Alpine Energy Systems' website and services, you
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Alpine Energy Systems provides IoT-based energy monitoring and
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Alpine Energy Systems is currently in beta testing. Beta participants
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              systems. Alpine Energy Systems is granted a license to process this
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              All content, features, and functionality of Alpine Energy Systems,
              including but not limited to software, algorithms, designs, and
              trademarks, are owned by Alpine Energy Systems and are protected by
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Alpine Energy Systems shall not be liable for any indirect, incidental,
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              While Alpine Energy Systems aims to reduce energy consumption by 20-40%,
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              By using Alpine Energy Systems, you acknowledge that you have read,
